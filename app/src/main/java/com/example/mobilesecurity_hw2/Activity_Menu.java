...
public class Activity_Menu extends AppCompatActivity {
    ...
    private void initViews() {
        this.menu_BTN_start.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                int inputLength = menu_EDT_id.getEditableText().length();
                if(inputLength != 9)
                    Toast.makeText(getBaseContext(), "ID is invalid", Toast.LENGTH_SHORT).show();
                else
    ...
    public void startGame(String id, String data) {
        int x = Integer.valueOf(String.valueOf(id.charAt(7)));
